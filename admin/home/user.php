    ...
    <div class="container-xl px-4 mt-5">
        ...
        <div class="card mb-4">
            <div class="card-header text-white bg-teal">Users Table
                <button class="btn btn-primary btn-icon-split btn-sm float-end" data-bs-toggle="modal" data-bs-target="#add_user"> 
                        ...
                        $(document).ready(function() {
                            var dataTable = $('#datatablesSimple1').DataTable({
                                ...
                                'columns': [
                                    ...
                                    { data: 'birthday', className: 'text-left' },
...
<!-- Modal -->
<div class="modal fade" id="add_user" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="add_userLabel" aria-hidden="true">
