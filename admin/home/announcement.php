                                ...
                                columns: [
                                    ...
                                    { data: 'ann_status', className: 'text-center' },
                                    {
                                        ...
                                        render: function(data, type, row, meta) {
                                            ...
                                            '<button class="btn btn-datatable btn-icon btn-transparent-dark" data-bs-toggle="modal" data-bs-target="#btn_edit_ann" data-edit_ann_id="' + data.ann_id + '" data-edit_ann_title="' + data.ann_title + '" data-edit_ann_description="' + data.ann_description + '" data-edit_ann_status="' + data.ann_status + '" onclick="editModal(this)" title="Edit"><i class="fa fa-edit"></i></button>'+
